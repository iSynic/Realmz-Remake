...
static func special_effect(_castercrea, _spell, _power, _main_targeted_tile, _effected_tiles, _effected_creas, _add_terrain) :
	...
	match aoe_shape :
		ixi :
			creature_name = ScriptHelperFuncsClass.get_random_creature_of_size(Vector2i.ONE, false, 3)
		ixii :
			creature_name = ScriptHelperFuncsClass.get_random_creature_of_size(Vector2i(1,2), false, 3)
		iixi :
			creature_name = ScriptHelperFuncsClass.get_random_creature_of_size(Vector2i(2,1), false, 3)
		iixii :
			creature_name = ScriptHelperFuncsClass.get_random_creature_of_size(Vector2i(2,2), false, 3)
		_ :
			creature_name = ScriptHelperFuncsClass.get_random_creature_of_size(Vector2i.ONE, false, 3)
