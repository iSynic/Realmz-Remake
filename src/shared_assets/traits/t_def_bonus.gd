const name : String = 't_def_bonus.gd'
const menuname : String = 'Defense_Bonus (T)'
...
func _init(args : Array):
	...
	chara = args[0]
	duration = 5*args[1]
	UI.ow_hud.creatureRect.logrect.log_other_text(chara, 'gets a Defense Bonus !', null,'')
...
func get_info_as_text() -> String :
	return 'Defense Bonus for '+str(duration)+' rounds'
